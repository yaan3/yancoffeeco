...
urlpatterns = [
    ...
    path('razorpay-repayment/<int:order_id>/', views.razorpay_repayment, name='razorpay_repayment'), 
    path("order/<int:order_id>/repay/", views.razorpay_repayment, name="razorpay_repayment"),
    path("payment-handler/", views.razorpay_payment_handler, name="razorpay_payment_handler"),
