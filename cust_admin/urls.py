...
from .views import get_category_sales_data,get_top_selling_products_data
...
urlpatterns = [
    ...
    path('get_category_sales_data/', get_category_sales_data, name='get_category_sales_data'),
    path('get_top_selling_products_data/', get_top_selling_products_data, name='get_top_selling_products_data'),
